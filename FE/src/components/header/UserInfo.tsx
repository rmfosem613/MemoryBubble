...
import { Copy, X, Edit2, Settings, LogOut, UserRound } from 'lucide-react';
...
import { useHasCompleteProfile } from '@/hooks/useUserSatus';
    ...
    <>
      <div className="relative" ref={dropdownRef}>
        ...
        {user.profileUrl ? (
          ...
          <div
            className="h-10 w-10 md:h-11 md:w-11 rounded-full bg-gray-200 flex items-center justify-center cursor-pointer"
            onClick={(e) => {
              e.stopPropagation();
              toggleDropdown();
            }}>
            <UserRound className="text-gray-500" size={24} />
          </div>
        )}
