  ...
  return (
    <div
      ...
      <div className="flex-row justify-between h-full p-3 border-t w-[130px]">
        <p className="font-p-500 text-subtitle-1-lg text-gray-800">
          {letter.senderName}
        </p>
        <div className="flex-row justify-between mt-[30px]">
          <p className="font-p-400 text-p-lg text-gray-500">{letter.isRead}</p>
          <p className="font-p-400 text-p-lg">{letter.openAt}</p>
        </div>
      </div>
    </div>
  );
