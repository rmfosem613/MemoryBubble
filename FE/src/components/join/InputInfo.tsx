    ...
    <div className='flex-row space-y-3'>
      ...
      <div>
        <div className="flex justify-between">
          <label htmlFor="nameInput" className="font-p-500 text-subtitle-1-lg">
            이름(별명)
            <span className="text-gray-500 text-subtitle-2-lg pl-1">
            (최소 1자~최대 10자)
            </span>
          </label>
          <p className="text-gray-600 text-sm">{name.length || 0}/10
          </p>
        </div>
        <input
          id="nameInput"
        ...
        <div>
          ...
          <div className="relative">
            ...
            <span className={gender ? 'text-black' : 'text-gray-500'}>{gender || '성별을 선택해 주세요'}</span>{/* 성별 선택 상태 */}
